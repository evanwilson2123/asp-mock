...
// /**
//  * TODO:
//  * - make a toggle button to toggle between the current view
//  *   and a similar view to what is seen on the Admin Dashboard
//  *   but only showing the athlete that is signed in's numbers.
//  *   The intention behind this addition is to give athletes a view
//  *   of their progress over time for statistics without needing to delve
//  *   into the pages under their profile.
//  */
...
//     if (!stats) {
//       const res = await fetch(`/api/athlete/${resolvedAthleteId}`)
//     }
//   }
