...
const AssesmentPage: React.FC = () => {
  ...
  // Prepare the main content based on athlete selection
  const content = !selectedAthlete ? (
    <div className="p-6 bg-gray-100 flex-1">
      <h1 className="text-2xl font-bold text-gray-700 mb-6">Select Athlete</h1>
      {athletesLoading ? (
  ...
  // Wrap the content with a conditional sidebar (desktop & mobile)
  return (
