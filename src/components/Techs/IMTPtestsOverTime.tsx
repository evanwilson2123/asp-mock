      ...
      datasets: [
        {
          ...
          data: dataOverTime.map((d) => d.netPeakVerticalForce),
      ...
      datasets: [
        {
          ...
          data: dataOverTime.map((d) => d.peakVerticalForce),
      ...
      datasets: [
        {
          ...
          data: dataOverTime.map((d) => d.forceAt100ms),
